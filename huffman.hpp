...
//Defining the structure of a Huffman Tree Node
struct Node
{
    char data;
    unsigned freq;
...
private:
    ...
    /*  Initialising a vector of tree nodes representing character's ascii value and initialising its frequency with 0  */
    void createVec();
